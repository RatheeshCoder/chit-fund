  ...
  return (
    <section className="small-chit-funds">
      <div className="cta-title">
        <h1>term chit details - 40 months</h1>
      </div>

      <div className="cta-all-small-fund">
        {high_fund.map((product, index) => (
      ...
      {tableData[0] && (
        <table>
          <tbody>
            ...
            {tableData.slice(1, Math.min(21, tableData.length)).map((row, rowIndex) => (
              <tr key={rowIndex}>
      ...
      {tableData[0] && (
        <table>
          <tbody>
            ...
            {tableData.slice(21, Math.min(41, tableData.length)).map((row, rowIndex) => (
              <tr key={rowIndex}>
                {row.map((cell, colIndex) => (
                  <td key={colIndex}>{cell}</td>
                ))}
