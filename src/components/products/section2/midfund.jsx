      ...
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="relative max-w-xl mx-auto sm:text-center">
          ...
          <div className="mt-3 max-w-xl">
            <p>
              Fuel your financial destiny with ChitFunds—an odyssey to unmatched
              prosperity. Join our community for strategic investments and
              unparalleled wealth growth.
            </p>
          </div>
        </div>
