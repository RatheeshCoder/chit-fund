  ...
  return (
    <div className="max-w-6xl px-4 mx-auto md:max-w-4xl sm:max-w-2xl sm:px-6 mt-60">
      <div className="text-center">
        <h1 className="max-w-md mx-auto lg:text-7xl text-4xl md:text-5xl font-bold tracking-tight text-gray-900 sm:text-3xl md:text-5xl lg:text-6xl md:leading-none sm:max-w-xl md:max-w-2xl lg:max-w-4xl">
          <span className="block"> Vanmoh's <span className='text-transparent bg-clip-text bg-gradient-to-r from-blue-700 via-blue-800 to-gray-900'>Leaders</span></span>
        </h1>
