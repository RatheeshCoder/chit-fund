  ...
  return (
    <section className="py-28 relative bg-blue-600 text-center ">
        <div className="relative max-w-screen-xl mx-auto px-4 md:text-center md:px-8">
            ...
            <div className="mt-4">
                <Link to="/ContactMain" className="inline-block py-2 px-4 text-gray-800 font-medium bg-white duration-150 hover:bg-gray-100 active:bg-gray-200 rounded-full">
                    Get started
                </Link>
            </div>
        </div>
