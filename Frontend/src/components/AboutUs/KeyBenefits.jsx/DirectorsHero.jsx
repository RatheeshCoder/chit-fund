  ...
  return (
    <div className="max-w-6xl px-4 mx-auto md:max-w-4xl sm:max-w-2xl sm:px-6 cta-team-top">
      <div className="text-center">
        <h1 className="max-w-md mx-auto text-4xl font-bold tracking-tight text-gray-900 lg:text-7xl md:text-5xl sm:text-3xl lg:text-6xl md:leading-none sm:max-w-xl md:max-w-2xl lg:max-w-4xl">
